...
HD_PWD='/home/c0rnpotato/codespace/soc/soc2/soc_week4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hy_soc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hy_soc.tcl
