...
HD_PWD='/home/c0rnpotato/codespace/soc/soc2/soc_week4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hy_soc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hy_soc.tcl -notrace
